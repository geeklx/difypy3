...
from yewu2story.exceptions import LLMResponseValidationError
from yewu2story.const import LANGUAGE_NAMES, Language
from yewu2story.llmschemas import (
...
openai_api_key = 'sk-e67YtYgbwDxm5yPHpHl4S1TOPbvd03bK2KCzme4knXG6qgby'
openai_base_url = 'https://api.cursorai.art'
aliyun_api_key = 'sk-c59a31cce2c442eaa7fae4790182b5b3'
aliyun_base_url = 'https://dashscope.aliyuncs.com/compatible-mode/v1'
deepseek_api_key = 'sk-53e19b5b47db4194912d1c254ecc3d43'
deepseek_base_url = 'https://dashscope.aliyuncs.com/compatible-mode/v1'
ollama_api_key = ''
ollama_base_url = 'http://localhost:11434/v1'
siliconflow_api_key = 'sk-xlnroajavslhhuvfaijqkgqpzzsdqhmmsyzlulvhqhmsrgml'
siliconflow_base_url = 'https://api.siliconflow.cn/v1'
intern_base_url = 'https://chat.intern-ai.org.cn/api/v1'
intern_api_key = 'eyJ0eXsssssss'
...
class LLMService:
    ...
    async def _generate_response(self, *, text_llm_provider: str = None, text_llm_model: str = None,
        ...
        if text_llm_provider in ["openai", "aliyun"]:
        ...
        # 4. 尝试解析 JSON（兼容多种格式）
        try:
            return json.loads(content)  # 直接解析
