...
from yewu2story.llmschemas import StoryGenerationRequest
from yewu2story.videoschemas import VideoGenerateRequest, StoryScene
from yewu2story.llmservices import llm_service
from yewu2story.voiceservices import generate_voice
from yewu2story import utils
...
async def create_video_with_scenes(task_dir: str, task_id: str, scenes: List[StoryScene], voice_name: str,
    ...
    local_url = f"http://g19.geekaiapp.icu/tasks/{task_id}/{video_filename}"
    # 上传视频到腾讯云COS
